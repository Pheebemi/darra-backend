        ...
        {payouts.length === 0 ? (
          ...
          <div className="space-y-4">
            {payouts.map((payout) => {
              ...
              return (
                <div key={payout.id} className="rounded-3xl border border-line bg-surface p-6">
                  {/* Header */}
                  ...
                  {/* Details */}
                  <div className="grid gap-x-8 gap-y-2 border-t border-line pt-4 sm:grid-cols-2">
                    {[
                      ...
                      <div key={k} className="flex items-center gap-2 text-sm">
                        <Icon className="h-4 w-4 shrink-0 text-accent-link" />
